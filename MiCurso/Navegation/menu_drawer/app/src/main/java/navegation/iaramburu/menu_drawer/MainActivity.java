package navegation.iaramburu.menu_drawer;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Manipular el header del menu de navegacion drawer
        ...
        nombre.setText("Iñaki");
        email.setText("iñaki@iñaki.es");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu_body_averias) {
            // Handle the camera action
            f=new ListadoAveriasFragment();
        } else if (id == R.id.menu_body_talleres) {
            f=new ListadoTalleresFragment();
